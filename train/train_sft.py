...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", type=int, default=52, help="Batch size per device")
    ...
    # Output
    parser.add_argument("--save_every", type=int, default=2, help="Save checkpoint every N steps")
