...
|--------|--------|-----------------|
| Summer | Apr–May | 1.15× (scarce supply) |
| Monsoon | Jun–Sep | 1.00× |
| Winter | Oct–Jan | 0.95× (post-harvest oversupply) |
| Spring | Feb–Mar | 0.95× |
...
| Inflation rate | 0% | 3% | 7% |
| Weather & Market noise | Low | Standard | High |
| Starting Nitrogen | 0.8 | 0.6 | 0.35 |
| Max storage age | 12 months | 6 months | 4 months |
| Monthly overhead | ₹100 | ₹200 | ₹300 |
| Max calendar months | 60 | 60 | 60 |
